...
namespace NaninovelSceneAssistant {
    ...
    public interface ISceneAssistantLayout
    {
        ...
        void Vector3Field(ParameterValue param, bool includeZPos = true, ParameterValue toggleWith = null);
        void Vector4Field(ParameterValue param, ParameterValue toggleWith = null);
        void PosField(ParameterValue param, CameraConfiguration cameraConfiguration, bool includeZPos = true, ParameterValue toggleWith = null);

...
namespace NaninovelSceneAssistant
{
    public class CameraData : NaninovelObjectData<ICameraManager, CameraConfiguration>, INaninovelObjectData
    {
        ...
        protected override void AddCommandParameters()
        {
            ...
            CommandParameters.Add(rotation = new CommandParameterData<Vector3>("Rotation", () => CameraManager.Rotation.eulerAngles, v => CameraManager.Rotation = Quaternion.Euler(v), (i,p) => i.Vector3Field(p, toggleGroup: roll)));
            CommandParameters.Add(roll = new CommandParameterData<float>("Roll", () => CameraManager.Rotation.eulerAngles.z, v => CameraManager.Rotation = Quaternion.Euler(CameraManager.Rotation.eulerAngles.x, CameraManager.Rotation.eulerAngles.y, v), (i,p) => i.FloatField(p, toggleGroup:rotation)));
